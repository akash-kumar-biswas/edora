    ...
    <div class="d-flex">
        ...
        <div class="instructor-sidebar d-flex flex-column text-white">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                    <a href="{{ route('instructor.enrollments') }}" class="nav-link {{ Request::is('instructor/enrollments*') ? 'active' : '' }}">
                        <i class="bi bi-journal-check me-2"></i> Enrollments
                    </a>
                </li>
                <li class="nav-item mb-2">
                    <a href="{{ route('instructor.instructors') }}" class="nav-link {{ Request::is('instructor/instructors*') ? 'active' : '' }}">
