                    ...
                    <form method="GET" action="{{ route('courses.index') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="duration" class="form-select">
                                <option value="">All</option>
                                <option value="short" {{ request('duration') == 'short' ? 'selected' : '' }}>Short (&lt;= 5 hrs)</option>
                                <option value="medium" {{ request('duration') == 'medium' ? 'selected' : '' }}>Medium (6–20 hrs)</option>
                                <option value="long" {{ request('duration') == 'long' ? 'selected' : '' }}>Long (&gt; 20 hrs)</option>
                            </select>
                        </div>
